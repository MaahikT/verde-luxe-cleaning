      ...
      <div className="bg-[#EAE9E3] min-h-screen">
        {cleanerDetailsQuery.isLoading ? (
          ...
          <>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">
                        {cleanerDetailsQuery.data.customer.phone ? formatPhoneNumber(cleanerDetailsQuery.data.customer.phone) : "Not provided"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
            ...
            {console.log('Rendering Side Panel', { showSidePanel, selectedBooking })}
